...
export class AIDiscoveryEngine {
  ...
  private static instance: AIDiscoveryEngine | undefined
  ...
  constructor(
    ...
    model: string = (typeof process === 'undefined'
      ? undefined
      : process.env.EXPO_PUBLIC_AI_MODEL) || 'gemma2:2b',
  ) {
    this.model = model
    ...
    this.apiKey =
      ...
      (typeof process === 'undefined' ? undefined : process.env.GROQ_API_KEY)
  ...
  analyzeUserPreferences(shows: Array<Show>): {
    genres: Array<string>
    themes: Array<string>
    ...
    const themes = this.extractThemes(shows)
  ...
  public async getPersonalizedRecommendations(
    ...
    try {
      ...
      const preferences = this.analyzeUserPreferences(shows)
  ...
  private extractThemes(shows: Array<Show>): Array<string> {
